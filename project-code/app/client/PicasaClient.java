...
public class PicasaClient {
    ...
    private static PicasaClient singleton = null;

    private final PicasawebService service;

    private PicasaClient() {
        String name = Play.application()
                .configuration()
                .getString("picasa.name");
        service = new PicasawebService(name);
        String username = Play.application()
                .configuration()
                .getString("picasa.username");
        String password = Play.application()
                .configuration()
                .getString("picasa.password");
        try {
     ...
     */
    public AlbumEntry insertAlbum(AlbumEntry album) throws IOException,
            ServiceException {
